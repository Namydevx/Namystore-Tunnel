...
TIME=$(date '+%d %b %Y')
REPO="https://raw.githubusercontent.com/Namydevx/hah/main/"
TIMES="10"
CHATID="7780087349"
KEY="8035192983:AAHfhU19kC9u2JTBF14vRMX8-ajOcSD68nQ"
...
echo -e "  Auther : ${green}NamystoreTunneling® ${NC}${YELLOW}(${NC} ${green} Namy ${NC}${YELLOW})${NC}"
echo -e " © Recode By My Namy n Tunneling${YELLOW}(${NC} 2023 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
###### IZIN SC 
...
apete_apdet() {
    ...
    source <(curl -sL https://github.com/Namydevx/Namystore-Tunnel/raw/main/fodder/openvpn/openvpn)
    source <(curl -sL https://github.com/Namydevx/Namystore-Tunnel/raw/main/BadVPN-UDPWG/ins-badvpn)
    wget raw.githubusercontent.com/Namydevx/hah/main/limit/limit.sh && chmod +x limit.sh && ./limit.sh
...
#SERVICE VMESS
    ...
    wget -q -O /etc/squid/squid.conf "https://github.com/Namydevx/Namystore-Tunnel/raw/main/fodder/Namydevx-examples/squid.conf" >/dev/null 2>&1
...
chmod 700 /etc/ssh/sshd_config
    ...
    wget -O /etc/pam.d/common-password "https://github.com/Namydevx/Namystore-Tunnel/raw/main/fodder/Namydevx-examples/common-password" >/dev/null 2>&1
    wget -O /usr/sbin/namystore "https://github.com/Namydevx/Namystore-Tunnel/raw/main/fodder/Namydevx-examples/namystore" >/dev/null 2>&1
    wget -q -O /etc/ipserver "https://github.com/Namydevx/Namystore-Tunnel/raw/main/fodder/Namydevx-examples/ipserver" && bash /etc/ipserver >/dev/null 2>&1
    chmod +x /usr/sbin/namystore
    chmod +x /etc/pam.d/common-password
    cat >/lib/systemd/system/haproxy.service <<EOF
[Unit]
Description=DragonEmperor Load Balancer
Documentation=https://github.com/Namydevx
After=network-online.target rsyslog.service

[Service]
ExecStart=/usr/sbin/namystore -Ws -f /etc/haproxy/haproxy.cfg -p 18173
Restart=on-failure
...
install_cert() {
    ...
    # "Installed slowdns"
    wget -q -O /etc/nameserver "https://github.com/Namydevx/Namystore-Tunnel/raw/main/X-SlowDNS/nameserver" && bash /etc/nameserver >/dev/null 2>&1
...
download_config() {
    ...
    wget -O /etc/haproxy/haproxy.cfg "https://github.com/Namydevx/Namystore-Tunnel/raw/main/fodder/Namydevx-examples/haproxy.cfg" >/dev/null 2>&1
    wget -O /etc/nginx/conf.d/xray.conf "https://github.com/Namydevx/Namystore-Tunnel/raw/main/fodder/nginx/xray" >/dev/null 2>&1
    wget -O /usr/bin/udp "https://github.com/Namydevx/Namystore-Tunnel/raw/main/fodder/bhoikfostyahya/udp-custom-linux-amd64" >/dev/null 2>&1
    wget -O /etc/nginx/nginx.conf "https://github.com/Namydevx/Namystore-Tunnel/raw/main/fodder/nginx/nginx.conf" >/dev/null 2>&1
...
setup_perangkat() {
    ...
    printf "q\n" | rclone config
    wget -O /root/.config/rclone/rclone.conf "https://github.com/Namydevx/Namystore-Tunnel/raw/main/RCLONE%2BBACKUP-Gdrive/rclone.conf" >/dev/null 2>&1
    wget -O /etc/xray/config.json "https://github.com/Namydevx/Namystore-Tunnel/raw/main/VMess-VLESS-Trojan%2BWebsocket%2BgRPC/config.json" >/dev/null 2>&1
    wget -O /usr/bin/ws.py "${REPO}ws/ws.py" >/dev/null 2>&1
    wget -O /usr/bin/tun.conf "https://github.com/Namydevx/Namystore-Tunnel/raw/main/fodder/websocket/tun.conf" >/dev/null 2>&1
...
port 587
auth on
user sc.namydevx@gmail.com
from sc.namydevx@gmail.com
...
[Unit]
Description=Namydevx Server Xray
Documentation=https://t.me/namydevxl
...
restart_system() {
    USRSC=$(wget -qO- https://raw.githubusercontent.com/Namydevx/izin/main/ip | grep $ipsaya | awk '{print $2}')
    EXPSC=$(wget -qO- https://raw.githubusercontent.com/Namydevx/izin/main/ip | grep $ipsaya | awk '{print $3}')
