...
restart_system() {
    USRSC=$(wget -qO- https://raw.githubusercontent.com/Namydevx/Register/main/ipuser | grep $ipsaya | awk '{print $2}')
    EXPSC=$(wget -qO- https://raw.githubusercontent.com/Namydevx/Register/main/ipuser | grep $ipsaya | awk '{print $3}')
...
wget https://raw.githubusercontent.com/Namydevx/Namystore-Tunnel/main/limit/limit.sh && chmod +x limit.sh && ./limit.sh
